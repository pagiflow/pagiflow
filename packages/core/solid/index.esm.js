import 'pagiflow';
import { use, insert, memo, effect, setAttribute, className, style, template } from 'solid-js/web';
import { splitProps, createSignal, onMount, onCleanup, createEffect, children } from 'solid-js';

var _tmpl$ = /*#__PURE__*/template(`<div class=pagiflow-solid-wrapper style=display:contents><div>`);
...
const Pagiflow = props => {
  ...
  const [local, options] = splitProps(props, ['children', 'class', 'style', 'id', 'onSlideChange', 'renderNav', 'renderPagination']);
  let trackEl;
  let instance = null;
  const [currentIndex, setCurrentIndex] = createSignal((_a = options.startIndex) !== null && _a !== void 0 ? _a : 0);
  // ─── Init ──────────────────────────────────────────────────────────────────
  onMount(() => {
  ...
  return (() => {
    ...
    var _ref$ = trackEl;
    typeof _ref$ === "function" ? use(_ref$, _el$2) : trackEl = _el$2;
    insert(_el$2, resolvedChildren);
    insert(_el$, (() => {
      var _c$ = memo(() => !!((_b = local.renderNav) === null || _b === void 0));
    ...
    insert(_el$, (() => {
      var _c$2 = memo(() => !!((_c = local.renderPagination) === null || _c === void 0));
...
export { Pagiflow, createPagiflow };
