...
require('pagiflow');
var Pagiflow_svelte = require('./Pagiflow.svelte');
...
function createPagiflow(options = {}) {
    ...
    function action(node) {
        ...
        inst.onSlideChange((idx) => {
            store$1.update((s) => (Object.assign(Object.assign({}, s), { currentIndex: idx })));
        });
        store$1.update((s) => (Object.assign(Object.assign({}, s), { instance: inst })));
        return {
            destroy() {
                ...
                const current = store.get(store$1).instance;
                ...
                store$1.update((s) => (Object.assign(Object.assign({}, s), { instance: null })));
            },
        };
    }
    // ─── Stable API ────────────────────────────────────────────────────────────
    function getInstance() {
        return store.get(store$1).instance;
    }
    return {
...
exports.Pagiflow = Pagiflow_svelte;
