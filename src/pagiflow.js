!(function () {
  ...
  class o {
    ...
    createOrUpdateNav(t) {
      ...
      e ||
        ...
        (e.innerHTML = `\n        <button class="pagiflow-prev">${t.prevIcon || "‹"}</button>\n        <button class="pagiflow-next">${t.nextIcon || "›"}</button>\n      `),
    ...
    updateNavState() {
      ...
      const e = this.slides.length - this.currentPerSlide,
        s = this.index <= 0,
        n = this.index >= e;
    ...
    buildSlides(i = 1) {
      ...
      if (this.loop && !this.autoScroll && this.slides.length > 1) {
    ...
    buildPagination() {
      ...
      for (let s = 0; s < e; s++) {
        ...
        ((e.className = "pagiflow-dot"), 0 === s && e.classList.add("active"));
        const n = () => {
          const e = t;
    ...
    update(t = null) {
      ...
      const i = this.loop
        ? this.slides.length - 1
        : Math.max(0, this.slides.length - this.currentPerSlide);
      if (
        (this.loop || (this.index = Math.max(0, Math.min(this.index, i))),
      ...
      const n = (t) => (t.touches ? t.touches[0] : t),
        o = (o) => {
          ...
          (this.loop &&
            ...
            this.loop ||
              (((0 === this.index && a > 0) ||
                (this.index >= this.slides.length - 1 && a < 0)) &&
                (u *= 0.4)));
          ...
          if (
            ...
            let i,
              ...
              n = Math.round(e / t);
            if (this.loop) {
              const t = this.originalItems.length;
        ...
        l = () => {
          ...
          if ((this.rtl && !t && (i *= -1), this._isFadeActive())) {
            const t = this.options.swipeThreshold ?? 60;
            return (
          ...
          let l = n - i - o;
          if (!this.loop) {
            const t = (this.slides.length - this.currentPerSlide) * s;
          ...
          if (
            ...
            const t = Math.max(0, this.slides.length - this.currentPerSlide);
    ...
    getTranslate() {
      ...
      const s = this.loop
        ...
        : Math.max(0, this.slides.length - this.currentPerSlide);
      let n = this.index;
      this.loop || (n = Math.max(0, Math.min(n, s)));
      const o = n * e;
    ...
    prev() {
      ...
      } else if (this.index <= 0) return this;
    ...
    _getLoopTargetIndex(t) {
      ...
      const i = this.originalItems.length,
        e = this.cloneCount + t,
          ...
          if (e || ("ArrowUp" !== t.key && "ArrowDown" !== t.key)) {
            if (!e || ("ArrowLeft" !== t.key && "ArrowRight" !== t.key)) {
              ...
              return "Home" === t.key
                ...
                : "End" === t.key
                  ? (t.preventDefault(),
                    void this.goTo(this.originalItems.length - 1))
                  : void 0;
            }
            t.preventDefault();
  ...
  window.Pagiflow = function (t, i = {}) {
    if (("object" == typeof t && (t = (i = t).slider), !t))
      return (console.warn("Pagiflow: selector missing"), null);
    const s = [];
    return (
